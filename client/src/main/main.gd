...
func _ready() -> void:
	...
	home_button.pressed.connect(func() -> void: _on_home_button_pressed())
...
func _on_decks_button_pressed() -> void:
	Global.game_controller.gui_transition_to("deck builder")
	#if gui_state_machine.current_state:
		#gui_state_machine.current_state.Transitioned.emit(
			#gui_state_machine.current_state,
			#"deck builder"
...
func _on_settings_button_pressed() -> void:
	Global.game_controller.gui_transition_to("settings")
	#if gui_state_machine.current_state:
		#gui_state_machine.current_state.Transitioned.emit(
			#gui_state_machine.current_state,
			#"settings"
